...
Before beginning all over, this is one thing that we might take a look at.
...
So - now we have learned a bit that needs improving, and we can close (hopefully)
the book on preparing the data.